...
def get_neighborhood(
    ...
    if cutoff_lr is not None and cutoff_lr > cutoff:
        ...
        edge_index_lr, shifts_lr, unit_shifts_lr = None, None, None
    ...
    return edge_index, shifts, unit_shifts, cell, edge_index_lr, shifts_lr, unit_shifts_lr
