...
def test_mace_omol_elements_subset_reproduces_energy_forces():
    ...
    calc_foundation = mace_omol(model="/home/yuzhu/workspace/ckpt/MACE-omol-0-extra-large-1024.model", device="cpu", default_dtype="float64")
...
def test_remove_pt_head_omol_multihead():
    # Set up test data
    calc = mace_omol(model="/home/yuzhu/workspace/ckpt/MACE-omol-0-extra-large-1024.model", device="cpu", default_dtype="float64")
